...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 6jTXRcZVoW-/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___0XEq5)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__oAgQh)}
              />
            </React.Fragment>
          ),
          value: args.children
